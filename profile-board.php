...
<?php require_once 'template/page-top.php' ?>
  ...
  <p class="board-description">
  Jace Decory, MA
  <br />(Tribal Affiliation: Cheyenne River Sioux Tribe)
  <br />Professor Emeritus
  <br />Black Hills State University
  <br />Spearfish, South Dakota
  <br />
  <br />(In grateful memory of her service)
  </p>
  ...
  <p class="board-description">
  John Gritts
  <br />(Tribal Affiliation: Enrolled Cherokee)
  <br />Management &amp; Program Analyst (Retired)
  <br />US Department of Education
  <br />Denver, Colorado
  </p>
  
  <div class="clearfix"></div>
  <img class="board-profile" src="pictures/profiles/rtheisz1.png" />
  <p class="board-description">
  Ronnie Theisz, PhD
  <br />Professor Emeritus,
  <br />Black Hills State University
  ...
  <br />Rapid City, South Dakota
  <br />
  <br />(In grateful memory of his service)
  </p>
  ...
  <p class="board-description">
  Barry Vickrey
  <br />Emeritus Professor of Law &amp; Former Dean
